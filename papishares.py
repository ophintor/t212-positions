...
def get_current_positions(db, all_tickers, risk_percentage = RISK_PERCENTAGE):
    ...
    for pos in positions:
        ...
        if position_dict["average_price"] > position_dict["stop_loss_price"]:
            if position_dict["manual_stop_loss_price"]:
                risk_percentage = (position_dict["average_price"] - position_dict["manual_stop_loss_price"]) / position_dict["average_price"]
            else:
                risk_percentage = (position_dict["average_price"] - position_dict["stop_loss_price"]) / position_dict["average_price"]
